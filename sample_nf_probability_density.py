''' https://github.com/jrleja/sfs_leja_trained_flow/blob/main/code/sample_nf_probability_density.py '''
...
nlogm, nsfr, dz = 50, 60, 0.02
ndummy = 31
mmin, mmax = 7.0, 12.0
sfrmin, sfrmax = -5.7, 2.0
zmin, zmax = 0.2, 0.67
...
def load_nf():
    ...
    loc = Path('./trained_flow_nsamp100.pth')
